...
CompassFactory::CompassFactory(QObject *parent) : QObject(parent)
{

}

QwtCompass *CompassFactory::createCompass(int pos)
{
    int c;
    ...
    palette0.setColor( QPalette::Base,
                       p.color( QPalette::Background).light(120) );
    palette0.setColor( QPalette::WindowText,
                       palette0.color( QPalette::Base ) );

    QwtCompass *compass = new QwtCompass( dynamic_cast<QWidget*>(this));
